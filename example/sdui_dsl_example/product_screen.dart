...
/// ```bash
/// dart run sdui add-widget RatingStars       # scaffold files (already done)
/// dart run sdui export product_screen product_rating   # export this node
/// dart run sdui export product_screen review_card      # export a review card
/// ```
///
/// Output goes to: exported_json/product_screen.json
// ignore: depend_on_referenced_packages
import 'package:sdui_library/sdui_dsl.dart';
// ignore: depend_on_referenced_packages
import '../lib/sdui_widgets/rating_stars/rating_stars_encoder.dart';
