...
// ─────────────────────────────────────────────────────────────────────────────
// Variable names don't matter — only the Key() value is used by the CLI.
// Using 'final _' to make it clear the variable name is discarded.
// ─────────────────────────────────────────────────────────────────────────────
...
Column _statCard(String value, String label, String bgColor) {
  return Column(
    children: [
      Container(
        padding: {'horizontal': 16, 'vertical': 12},
...
Container _recentItem(String name, String bgColor, String iconName) {
  return Container(
    color: bgColor,
    borderRadius: 10,
    padding: {'horizontal': 16, 'vertical': 12},
